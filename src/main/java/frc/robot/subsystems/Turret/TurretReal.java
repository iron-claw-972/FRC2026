...
//     public TurretReal() {
//         motor = new TalonFX(IdConstants.BASE_MOTOR_ID, Constants.CANIVORE_CAN); // switch of course
...
//         double motorTargetRotations = (clampedSetpoint / 360.0) * 1; // gear ratio of 1
