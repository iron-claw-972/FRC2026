...
public class FieldConstants {
  ...
  public static final double RED_BORDER = FIELD_LENGTH / 2 + Units.inchesToMeters(179);
  public static final double BLUE_BORDER = FIELD_LENGTH / 2 - Units.inchesToMeters(179);
